...
<title><?php if (!empty($q)) {
    echo "搜索：" . strip_tags($q) . " - ";
}
    ...
    <div class="span12">
      ...
      <form class="form-search" id="q-form" method="get">
        ...
        <div class="condition" id="q-options">
          <label class="radio inline"><input type="radio" name="f" value="title" <?php echo $f_title ?? ''; ?> />标题</label>
          <label class="radio inline">
            <input type="radio" name="f" value="_all" <?php echo $f__all ?? ''; ?> />全文
          </label>
          <label class="checkbox inline">
            <input type="checkbox" name="m" value="yes" <?php echo $m; ?> />模糊搜索
          </label>
          <label class="checkbox inline">
            <input type="checkbox" name="syn" value="yes" <?php echo $syn; ?> />同义词
          </label>
          按
